	...
	<div class="container px-6 my-6 grid">
		...
		<div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800" >
			<form action="/emprestimoAdmin" method="POST" enctype="multipart/form-data">
				...
				<button type="submit" onClick="window.parent.jQuery.fancybox.close();" class="px-4 py-2 font-medium leading-5 text-white transition-colors duration-150 bg-blue-600 border border-transparent rounded-lg active:bg-blue-600 hover:bg-blue-700 focus:outline-none focus:shadow-outline-blue" >
                  Salvar    
                </button>		
			</form>
		</div>
